        ...
        <div className="p-4">
            <div className="h-full border-2 hover:border-primary-pink border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                    ...
                    <p className="leading-relaxed mb-3">{service?.description.length > 50 && service?.description.slice(0, 100) + '...'}</p>
                    <div className="flex items-center flex-wrap ">
                        <a className="btn btn-secondary inline-flex items-center md:mb-2 lg:mb-0">Learn More
