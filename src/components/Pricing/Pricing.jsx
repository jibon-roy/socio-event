            ...
            <section className="text-gray-600 body-font overflow-hidden">
                <div className="container px-5 py-10 mx-auto">
                    ...
                    <div className="md:flex -m-4 justify-center">
                        <div className="p-4 xl:w-1/4 md:w-1/2 w-full" data-aos='fade-down'>
                            <div className="h-[430px] p-6 rounded-lg border-2 border-gray-300 flex flex-col relative overflow-hidden">
                                ...
                                <p className="flex items-center text-gray-600 mb-2">
                                    ...
                                    </span>Essential services included.
                                </p>
                                <p className="flex items-center text-gray-600 mb-2">
                                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" className="w-3 h-3" viewBox="0 0 24 24">
                                    ...
                                    </span>Affordable solution for smaller events.
                                </p>
                                <p className="flex items-center text-gray-600 mb-6">
                                    ...
                                    </span>User-friendly event planning platform.
                                </p>
                                <p className="flex items-center text-gray-600 mb-6">
                                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" className="w-3 h-3" viewBox="0 0 24 24">
                        ...
                        <div className="p-4 xl:w-1/4 max-lg:hidden md:w-1/2 w-full" data-aos='fade-up'>
                            <div className="h-[500px] p-6 rounded-lg border-2 border-primary-pink flex flex-col relative overflow-hidden">
                                ...
                                <p className="flex items-center text-gray-600 mb-2">
                                    ...
                                    </span>Enhanced services and premium features.
                                </p>
                                <p className="flex items-center text-gray-600 mb-2">
                                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" className="w-3 h-3" viewBox="0 0 24 24">
                                    ...
                                    </span>Ideal for mid-sized gatherings.
                                </p>
                                <p className="flex items-center text-gray-600 mb-2">
                                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" className="w-3 h-3" viewBox="0 0 24 24">
                                    ...
                                    </span>Priority customer support included.
                                </p>
                                <p className="flex items-center text-gray-600 mb-6">
                                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" className="w-3 h-3" viewBox="0 0 24 24">
                        ...
                        <div className="p-4 xl:w-1/4 md:w-1/2 w-full" data-aos='fade-down'>
                            <div className="h-[430px] p-6 rounded-lg border-2 border-purple-500 flex flex-col relative overflow-hidden">
                                ...
                                <p className="flex items-center text-gray-600 mb-2">
                                    ...
                                    </span>Top-tier services and premium features.
                                </p>
                                <p className="flex items-center text-gray-600 mb-2">
                                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" className="w-3 h-3" viewBox="0 0 24 24">
                                    ...
                                    </span>Perfect for large-scale events.
                                </p>
                                <p className="flex items-center text-gray-600 mb-2">
                                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" className="w-3 h-3" viewBox="0 0 24 24">
                                    ...
                                    </span>Exclusive community and 24/7 support.
                                </p>
                                <p className="flex items-center text-gray-600 mb-6">
                                    <span className="w-4 h-4 mr-2 inline-flex items-center justify-center bg-gray-400 text-white rounded-full flex-shrink-0">
                                        <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" className="w-3 h-3" viewBox="0 0 24 24">
                                    ...
                                    </span>Empower professional event management.
                                </p>
                                <button className="flex items-center mt-auto text-white bg-purple-500 border-0 py-2 px-4 w-full focus:outline-none hover:bg-purple-600 btn btn-neutral rounded">Bok Us Now
                                    <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-auto" viewBox="0 0 24 24">
                                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                                    </svg>
                                </button>
                    ...
                    <div className="p-4 lg:hidden block mx-auto xl:w-1/4 md:w-1/2 w-full" data-aos='fade-up'>
                        <div className="h-[500px] p-6 rounded-lg border-2 border-primary-pink flex flex-col relative overflow-hidden">
                            <span className="bg-purple-500 text-white px-3 py-1 tracking-widest text-xs absolute right-0 top-0 rounded-bl">POPULAR</span>
                            <h2 className="text-sm tracking-widest title-font mb-1 font-medium">PRO</h2>
                            <h1 className="text-5xl text-gray-900 leading-none flex items-center pb-4 mb-4 border-b border-gray-200">
